...
final_styles = """
        ...
        @media (max-width: 900px) {
            ...
            .logo-container img {
                height: 55px !important; /* Logo made bigger as requested */
                max-width: 200px;
                object-fit: contain;
                margin: 0 !important;
            }
            .hamburger { 
                ...
                top: 23px !important; /* Fixed top position to stay put when menu opens */
                margin: 0 !important;
            }
...
print("Updated logo size and fixed icon positions on mobile.")
