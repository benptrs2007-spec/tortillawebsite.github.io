...
products = [
    {
        "file": "dill-pickle-chips.html",
        "image": "dillpickle.webp",
        "id": "BQPLBK48D9BYW",
        "name": "Dill Pickle Tortilla Chips"
    },
    {
        "file": "mexican-spice-chips.html",
        "image": "mexican-spice-chip.webp",
        "id": "UYKZ8X3CJ8L4E",
        "name": "Mexican Spice Tortilla Chips"
    },
    {
        "file": "nacho-cheese-chips.html",
        "image": "nachocheese.webp",
        "id": "7F73STYQQLE24",
        "name": "Nacho Cheese Tortilla Chips"
    },
    {
        "file": "kale-chips.html",
        "image": "kale.webp",
        "id": "RKM9MHMU7MJAC",
        "name": "Kale Tortilla Chips"
    },
    {
        "file": "multigrain-chips.html",
        "image": "multigrain.webp",
        "id": "M6JQZQ6KKDP6L",
        "name": "Multigrain Tortilla Chips"
    },
    {
        "file": "sea-salt-chips.html",
        "image": "sea-salt-chip.webp",
        "id": "GUYQTJ94KJ6SG",
...
<head>
    ...
    <style>
        ...
        * {{ margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }}
        ...
        .promo-banner {{
            background: #7d6e53; /* Matches your 'badge' color for consistency */
            color: white;
            text-align: center;
            padding: 12px 20px;
            font-size: 0.85rem;
        ...
        .promo-banner span {{
            color: #ece6d9; /* Subtle contrast for the "FREE SHIPPING" part */
            font-weight: 400;
            margin-left: 10px;
        }}
        ...
        /* --- Layout Adjustment --- */
        header {{
            top: 55px !important; /* Adjust this value if the banner height changes */
        }}
        ...
        @media (max-width: 900px) {{
            ...
            .product-detail-container {{ padding-top: 200px; flex-direction: column; text-align: center; gap: 40px; }}
...
<body>
    ...
    <section class="product-detail-container">
        ...
        <div class="product-info">
            <h1>{name}</h1>
            <p class="description">Experience the unmistakable crunch and quality of J&D Peters {name}. Handcrafted with care from our family to yours, these authentic tortillas feature a heritage-quality taste you won't find anywhere else. No artificial flavors, just simple, recognizable ingredients.</p>
            <div class="add-to-cart-container">
                <paypal-add-to-cart-button data-id="{id}"></paypal-add-to-cart-button>
                <script>
